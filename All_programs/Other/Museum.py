"""Необходимо написать программу описания музеев. Экспонаты представляются объектами своих классов.
Для примера объявим в программе следующие классы экспонатов"""
...
class Museum:
    ...
    def get_info_exhibit(self, indx):
        exhibit = self.exhibits[indx] #получаем экспонат по индексу из списка экспонатов
